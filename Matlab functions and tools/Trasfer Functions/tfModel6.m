function [tf1, tf2, A, B, C] = tfModel6(Par)
    ...
    A = [0 0 1 0;
          0 0 0 1;
          -(Par.Ks*k6)/(k1*k6-k2*k5) (k2*k8)/(k1*k6-k2*k5) -(k3*k6)/(k1*k6-k2*k5) (k2*k7)/(k1*k6-k2*k5);
          (Par.Ks*k5)/(k1*k6-k2*k5) -(k1*k8)/(k1*k6-k2*k5) (k3*k5)/(k1*k6-k2*k5) -(k1*k7)/(k1*k6-k2*k5)];
