...
rmpath(genpath('..\DiscreteTimeModel'));
...
nlobj.Model.StateFcn = @(x,u,bm,g,I2,Jeq,Jm,Kf1,Kf2,Km,Ks,l1,l2,m1,m2,Rm,x1,x2) PendulumContinuousModel(x,u,bm,g,I2,Jeq,Jm,Kf1,Kf2,Km,Ks,l1,l2,m1,m2,Rm,x1,x2);
nlobj.Model.IsContinuousTime = true;
nlobj.Model.NumberOfParameters = 16;

nlobj.Model.OutputFcn = 'PendulumOutputFcn';
nlobj.Jacobian.OutputFcn = @(x,u,bm,g,I2,Jeq,Jm,Kf1,Kf2,Km,Ks,l1,l2,m1,m2,Rm,x1,x2) [1 0 0 0; 0 0 1 0];

%% Define Cost and Constraints
nlobj.Weights.OutputVariables = [3 10];
...
uVal = 0.4;
validateFcns(nlobj,xVal,uVal,[],{bm,g,I2,Jeq,Jm,Kf1,Kf2,Km,Ks,l1,l2,m1,m2,Rm,x1,x2});
...
if matlabSim    
    ...
    nloptions.Parameters = {bm,g,I2,Jeq,Jm,Kf1,Kf2,Km,Ks,l1,l2,m1,m2,Rm,x1,x2};

    % Compute optimal control moves.
    [mv,nloptions,info] = nlmpcmove(nlobj,x,mv,yref,[],nloptions);
    
    pendulumPlanning(info);
end
